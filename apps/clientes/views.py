...
from .serializers import ClienteSerializer, PersonaAutorizadaSerializer, RegistroClienteSerializer
...
class ClienteViewSet(viewsets.ModelViewSet):
    ...
    # POST /api/clientes/registro/  — público, sin autenticación
    @action(detail=False, methods=["post"], url_path="registro", permission_classes=[AllowAny])
